...
<body  background="4237525-background-hd.jpg"> <br><br><br><br><br><br><br><br>
<% 
response.setHeader("Cache-Control", "no-cache,no-store,must-revalidate"); 
%>


<h2><p align="center">PASSWORD RECOVERY PAGE</p></h2><br><br><br>
...
<p align="center"><input type="submit" style="width:100px ; background-color:pink ;padding:3px ;margin-left:11px " value="SUBMIT"></p>
</form>
</body>
</html>